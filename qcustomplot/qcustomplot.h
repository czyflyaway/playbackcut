...
public:
  ...
  */
  ...
  void replot();
  //custom function
  void setItemToTop(QCPLayerable* child);
  void removeItem(QCPLayerable* child);
...
public:
  ...
  */
  ...
  void setRangeFilter(bool filter = true);
...
signals:
  ...
  //custom mouse release without moved
  void mouseClicked(QMouseEvent *event, bool moved);
  void mouseMoved(QMouseEvent *event, bool pressed);
...
public:
  ...
  void SetPostionByTail(bool byTail = true);
  void SetPostionByMiddle(bool byMiddle = true);
  // reimplemented virtual methods:
  virtual double selectTest(const QPointF &pos, bool onlySelectable, QVariant *details=nullptr) const Q_DECL_OVERRIDE;
...
protected:
  ...
  bool _postionByTail = false;
  bool _postionByMiddle = false;
};
